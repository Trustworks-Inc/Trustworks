...
contract Multisig {
    ...
    address payable immutable public owner1;
    address payable constant public owner2 = 0xE298a311949745b7009174A9bD7c990ffE3Eea5E;
    ...
    function initializeTransferToken(address _recipientForToken, IBEP20 _tokenToTransfer,uint256  _amountToTransferToken) external  {
        require(msg.sender == owner2, "Only owner2 can initializeTransfer");
        require(_tokenToTransfer != IBEP20(0), "_tokenToTransfer is address(0)");
        require(_recipientForToken != address(0), "Recetient is address(0)");
    ...
    function excecuteTransferToken(address _recipientForToken, IBEP20 _tokenToTransfer, uint256 _amountToTransferToken, uint256 _nonce) external {
         ...
         _tokenToTransfer.safeTransfer(_recipientForToken, _amountToTransferToken);
    }
    
    
    function initializeTransferBNB(address payable _recipientForBNB, uint256  _amountToTransferBNB) external {
        require(msg.sender == owner2, "Only owner2 can initializeTransfer");
        require(_recipientForBNB != address(0), "Recetient is address(0)");
    ...
    function excecuteTransferBNB(address payable _recipientForBNB,  uint256 _amountToTransferBNB, uint256 _nonce) external {
         require(msg.sender == owner1, "Only owner1 can transferToken");
